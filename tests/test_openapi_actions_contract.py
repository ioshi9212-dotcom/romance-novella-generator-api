...
def test_openapi_actions_use_compact_flat_turn_contract_without_required_auth():
    contract = build_openapi_actions("https://example.invalid")
...
def test_all_action_descriptions_fit_the_custom_gpt_limit():
    contract = build_openapi_actions("https://example.invalid")
    assert len(contract["info"]["description"]) <= 300
