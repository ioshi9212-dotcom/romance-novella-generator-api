...
- Body: 1800–3500 знаков, 5–9 плотных абзацев. scene.body должен содержать тот же полноценный body, а не краткий пересказ.
...
- Не делай пустой “Диалог” без смысла: если никто не говорит, дай короткую ремарку-паузу.
...
Далее body сцены полноценной прозой.

Диалог:
**Имя** — Реплика. *(короткая ремарка)*
Реплики в диалоге: имя всегда жирным; реплика обычным текстом; ремарка только курсивом в скобках. Не пиши "Имя —" без жирного имени. Сохраняй порядок ввода игрока: речь вне скобок = речь, текст в скобках = действие/пауза/мысль. Не переставляй действие перед репликой, если игрок сначала сказал реплику.
...
Правила: не делай важный выбор за игрока; сохраняй порядок ввода; NPC не читают мысли; не раскрывай hidden future; сцена должна иметь meaningful beat; proposed_updates сохраняют только важное. Нижний блок — короткая dashboard-панель, не объяснение сюжета.
""".strip()
