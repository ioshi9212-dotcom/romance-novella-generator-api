...
from app.session_intake import normalize_create_session_payload
...
class CreateSessionRequest(OpenModel):
    ...
    @classmethod
    def repair_fillable_transport_defects(cls, value: Any) -> Any:
        return normalize_create_session_payload(value)
