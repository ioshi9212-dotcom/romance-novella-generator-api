...
class NovellaService:
    ...
    def create_session(self, request: CreateSessionRequest) -> dict[str, Any]:
        ...
        normalization_notes = list(
            (request.model_extra or {}).get("intake_repairs_internal", [])
        )
        ...
        session = {
            ...
            "intake_normalization_applied": bool(normalization_notes),
        }
        manifest = {
            "session_id": session_id,
        ...
        writes: dict[str, Any] = {
            ...
            "intake/normalization_report.json": {
                "session_id": session_id,
        ...
        return {
            ...
            "next_required_action": (
                "Keep this exact session_id. Immediately call getTurnPacket with "
                "player_input='Начать стартовую сцену по подтверждённым данным' and mode='new'."
            ),
        }
