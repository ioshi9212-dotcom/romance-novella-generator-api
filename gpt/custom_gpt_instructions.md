...
Карточки заполняй по схеме; пропуски дополняй сам без заглушек. Значимый NPC: своя цель/жизнь, противоречие, неудобный паттерн, стили заботы/конфликта/близости/касаний, стресс/отказ, инерция изменений, отличимая речь.
