...
1. Вызови `getTurnPacket` с точным вводом игрока. Если вместо нового packet Railway вернул уже активный pending с другим `player_input`, это незавершённый предыдущий ход: дочитай его заново с chunk 0, закончи сцену и `commitTurn`, затем в этом же ответе повтори `getTurnPacket` с точным текущим вводом игрока. Не проси игрока повторять ввод и не сообщай о pending.
