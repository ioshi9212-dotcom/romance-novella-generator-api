...
Персонажи заполняются строго по Action-схеме. Всё, чего нет в анкете пользователя, придумай сам без заглушек. У каждого значимого NPC должны быть своя цель, жизнь вне героини, внутреннее противоречие, неудобный паттерн, стиль заботы/конфликта/близости/прикосновений, реакция на стресс и отказ, инерция изменений и узнаваемая речь.

cast_status: player — героиня; known_core/known_support — уже знакомы героине и видимы в preview; hidden_core — будущий важный персонаж с полной скрытой карточкой, но known_to_player=false, introduced=false, show_in_preview=false, available_to_scene=false; background — фон. hidden_core не ставить в active/nearby и не раскрывать в preview.
...
future_locks хранит технические блокировки раскрытия. Главный будущий NPC уже существует как hidden_core с полной скрытой карточкой; seed допустим только для далёкой неопределённой фигуры. Скрытое не показывать в preview/rendered_text/знаниях раньше времени.
