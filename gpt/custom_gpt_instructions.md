...
4. createBootstrapPreview только с bootstrap_json, без mode; внутри все корневые поля. UnrecognizedKwargsError → повтори в той же сессии, перенеся внешние поля в bootstrap_json.
